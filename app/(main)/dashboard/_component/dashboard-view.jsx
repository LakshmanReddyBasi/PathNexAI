...
const DashboardView = ({ insights }) => {
  // Transform salary data for the chart. Guard against missing data.
        ...
        <CardContent>
          {salaryData.length === 0 ? (
            <div className="p-6 text-center text-sm text-muted-foreground">
              Salary ranges are currently unavailable for this industry.
              This can happen when the AI model fails to return data or when
              insights are still being generated. Try refreshing the page or
              trigger a regeneration from the admin job.
            </div>
          ) : (
